...
<div class="mx-auto max-w-8xl py-8 my-12" style="background-color:<?=$section['background_color']??'#f9f9f9'?>">
            ...
            foreach($section['carousel_item'] as $item){?>
                <li class="glide__slide flex flex-col items-center justify-center pb-6">
                    <div class="w-full flex justify-center">
                        <img class="w-full h-[300px] object-contain" src="<?=$item['image']['url']; ?>" alt="placeholder image">
