...
//	return false;
   ...
   function CategoryEditor(args) {
    ...
    this.init = function () {
      ...
      $wrapper = $('<DIV style="z-index:10000;position:absolute;background:white;padding:25px;padding-top:5px;padding-bottom:12px;border:3px solid gray; -moz-border-radius:10px; border-radius:10px;min-width:150px;"/>')
          .appendTo($container);
