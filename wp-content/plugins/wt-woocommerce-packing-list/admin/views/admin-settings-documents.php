...
<div class="wf-tab-content" data-id="<?php echo $target_id;?>">
	...
	<div class="wt_info_box">
		<?php _e('The document types (Invoice, Packing slip, Shipping label, Dispatch label, Address label, and Delivery note) are enabled by default.','wf-woocommerce-packing-list'); ?>
		<br /><br />
		<i>
