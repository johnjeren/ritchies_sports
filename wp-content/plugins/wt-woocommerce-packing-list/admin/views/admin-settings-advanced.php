	    ...
	    self::generate_form_field(array(
			...
			array(
				...
				'help_text_conditional'=>array(
	                array(
	                    'help_text'=>__('All price columns displayed will be inclusive of tax.', 'wf-woocommerce-packing-list').$tax_not_enabled_info,
	                    'condition'=>array(
	                        array('field'=>'woocommerce_wf_generate_for_taxstatus', 'value'=>'in_tax')
	                    )
	                ),
	                array(
	                    'help_text'=>__('The tax amount will be displayed in a separate column, not included within the price.', 'wf-woocommerce-packing-list').$tax_not_enabled_info,
	                    'condition'=>array(
