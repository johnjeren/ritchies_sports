...
include_once('Exceptions/BarcodeException.php');
include_once('Exceptions/InvalidCharacterException.php');
include_once('Exceptions/InvalidCheckDigitException.php');
include_once('Exceptions/InvalidFormatException.php');
include_once('Exceptions/InvalidLengthException.php');
include_once('Exceptions/UnknownTypeException.php');
            ...
            default: { // MODE AUTO
                ...
                foreach ($sequence as $key => $seq) {
                    switch ($seq[0]) {
                        ...
                        case 'B': {
                            if ($key == 0) {
                                $tmpchr = ord(isset($seq[1][0]) ? $seq[1][0] : '12345');
