	...
	<table class="wf-form-table">
		...
		Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
			...
			array(
				...
				'module_base'=>$this->module_base,
				'help_text'=>__('Selected product meta will be displayed beneath the respective product in the credit note.','wf-woocommerce-packing-list'),
			),
			array(
				...
				'module_base'=>$this->module_base,
				'help_text'=>__('Selected product attribute will be displayed beneath the respective product in the credit note.', 'wf-woocommerce-packing-list'),
			),
			array(
				'type'=>"radio",
