...
class ExactMetrics_Email_Summaries {
	...
	public function get_header_image() {
		...
		$img = array(
			'url' => plugins_url( "lite/assets/img/emails/summaries/logo-ExactMetrics.png", EXACTMETRICS_PLUGIN_FILE ),
			'2x'  => plugins_url( "lite/assets/img/emails/summaries/logo-ExactMetrics@2x.png", EXACTMETRICS_PLUGIN_FILE ),
		);
	...
	public function set_template_args( $args ) {
		...
		$args['body']['title']       = esc_html__( 'Website Traffic Summary', 'google-analytics-dashboard-for-wp' );
		$args['body']['description'] = esc_html__( 'Let’s take a look at how your website traffic performed in the past month.', 'google-analytics-dashboard-for-wp' );
